  ...
  const experiences = [
    {
      ...
      period: "March 2026",
      type: "Job Simulation",
      description: "Completed Wells Fargo's Software Engineering Job Simulation on Forage, focusing on understanding financial portfolio management systems, data modeling, and implementing entity relationship diagrams.",
      achievements: [
      ...
      technologies: [
        "Java", "IntelliJ IDEA", "ERD Design", "Data Modeling", "Git", "GitHub", "Financial Systems"
      ],
      responsibilities: [
        {
          icon: Database,
          title: "Data Modeling",
          description: "Designing entity relationship diagrams for financial portfolio management systems"
        },
        {
          icon: FileCode,
          title: "System Implementation",
          description: "Implementing data models using IntelliJ and publishing to GitHub"
        },
        {
          icon: TrendingUp,
          title: "Requirements Analysis",
          description: "Understanding and translating business requirements for financial portfolio systems"
        }
      ],
      ...
      <div className="container-width">
        ...
        <div className="space-y-12">
          {experiences.map((experience, expIndex) => (
            <Card key={expIndex} className="card-floating hover:scale-[1.02] transition-all duration-500 overflow-hidden">
              <CardContent className="p-0">
                <div className="flex flex-col lg:flex-row">
                  <div className={`lg:w-2 w-full h-2 lg:h-auto bg-gradient-to-r lg:bg-gradient-to-b ${experience.gradient}`}></div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <Card className="card-glass p-6 text-center hover:scale-105 transition-all duration-300">
            ...
            <div className="text-foreground-muted">Experiences</div>
          </Card>
          <Card className="card-glass p-6 text-center hover:scale-105 transition-all duration-300">
